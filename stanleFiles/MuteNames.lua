...
if DevAbs:get(stanle.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(ReLaX.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAbs:get(ReLaX.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
ReLaXName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if ReLaXName then 
ReLaXNames = DevAbs:smembers(ReLaX.."Abs:Mute:Names"..msg.chat_id_) or ""
if ReLaXNames and ReLaXNames[1] then 
for i=1,#ReLaXNames do 
if ReLaXName:match("(.*)("..ReLaXNames[i]..")(.*)") then 
...
DevAbs:set(ReLaX.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(ReLaX.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
